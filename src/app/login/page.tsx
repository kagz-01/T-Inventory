    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-2.5 mb-8 animate-fade-in">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary shadow-lg shadow-primary/20 transition-all duration-300 hover:shadow-xl hover:shadow-primary/30">
        ...
        {/* Role selector */}
        <div className="flex gap-2 mb-6 animate-fade-in" style={{ animationDelay: "80ms" }}>
          {(Object.keys(roleConfig) as RoleSection[]).map((r) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex-1 flex flex-col items-center gap-1.5 rounded-xl border-2 p-3 transition-all duration-300",
                  isActive
        ...
        {/* Login card */}
        <div className={cn("card-glass rounded-2xl p-6 animate-fade-in-up", `border-2 ${config.border}`)} style={{ animationDelay: "160ms" }}>
          <div className="text-center mb-6">
            <div className={cn("flex h-14 w-14 items-center justify-center rounded-full mx-auto mb-3", config.bg)}>
        ...
        <p className="text-center text-xs text-muted-foreground mt-6 animate-fade-in" style={{ animationDelay: "240ms" }}>
